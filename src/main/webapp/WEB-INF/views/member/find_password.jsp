        	...
        	<div class="row member-row">
				<div class="panel panel-default">
					<div class="panel-body">
						<form id="findPasswordForm" action="${pageContext.request.contextPath}/find_password" method="post">
					...
					<div class="panel-footer member-row">
						<button class="btn btn-secondary member-table" id="find_password_button" type="button">비밀번호 변경</button>
					</div>
				</div>
			</div>
		</div>
